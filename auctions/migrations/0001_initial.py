...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('caterogy', models.CharField(max_length=64)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('starting_bid', models.IntegerField(validators=[auctions.models.valid_bid])),
                ...
                ('item_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auctions.auction_categories')),
